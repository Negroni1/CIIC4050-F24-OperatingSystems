...
// Function to add a command to the array of commands
void add_command(char ****execute_commands, int *commands_out,
  ...
  to_be_commands = realloc(to_be_commands, (param_out + 1) * sizeof(char *));
  to_be_commands[param_out] =
      NULL; // The last argument should be NULL for execvp
...
// Function to parse commands and their parameters into a nested array
...
// Function to execute parsed commands (forking and exec)
